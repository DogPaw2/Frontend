...
function MChattingInput(props){
    ...
    const confirmHandler = (e) => {
        ...
        if (ChatInput === "") {
            const data = {
                messageRoomId: props.currentMsgroom.messageRoom.id,
                userId: props.userId,
    ...
    return(
        <div className = "chatting_input_area"> 
            <div className = "content_add_btn_area">
                <label className="file-upload-label" for="message-file-upload-input">+</label>
                <input type="file" onChange={fileUploadHandler} className="file-upload-input" id ="message-file-upload-input"></input>
            </div>
